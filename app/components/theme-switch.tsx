...
export default function ThemeSwitch() {
  ...
  return (
    <div className="flex border-neutral-200 dark:border-neutral-700">
      <button
        onClick={() => setTheme("dark")}
        className={cx(
          "size-8 flex items-center justify-center lg:cursor-pointer text-neutral-600 hover:text-neutral-800 dark:text-neutral-300 dark:hover:text-neutral-100 transition-colors-opacity rounded-full opacity-80 hover:opacity-100",
          mounted &&
            theme === "dark" &&
            "bg-neutral-100 dark:bg-neutral-800 opacity-100"
        )}
      >
        <MoonIcon />
      </button>
